...
export const topScorers: PlayerStat[] = [
  ...
  { name: 'Anthony Elanga', teamCode: 'SWE', count: 1 },
  ...
  { name: 'Brian Brobbey', teamCode: 'NED', count: 2 },
...
export const cards: { name: string, teamCode: string, yellow: number, red: number }[] = [
  ...
  { name: 'Gervane Kastaneer', teamCode: 'CUW', yellow: 1, red: 0 },
  ...
  { name: 'Juninho Bacuna', teamCode: 'CUW', yellow: 1, red: 0},
