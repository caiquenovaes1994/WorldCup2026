...
export const knockoutTemplate: KnockoutMatch[] = [
  ...
  { id: 'R32-5', round: 'R32', position: 5, homeTeam: 'POR', awayTeam: 'CRO', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: 'Espen Eskas', date: '2026-07-02', time: '20:00', venueId: 'bmo', homeSource: '1G', awaySource: '3A/E/H/I/J' },
  { id: 'R32-6', round: 'R32', position: 6, homeTeam: 'ESP', awayTeam: 'AUT', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: 'Glenn Nyberg', date: '2026-07-02', time: '16:00', venueId: 'sofi', homeSource: '1I', awaySource: '3C/D/F/G/H' },
  { id: 'R32-7', round: 'R32', position: 7, homeTeam: 'USA', awayTeam: 'BIH', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: 'Raphael Claus', date: '2026-07-01', time: '21:00', venueId: 'levis', homeSource: '1K', awaySource: '3D/E/I/J/L' },
  ...
  { id: 'R32-13', round: 'R32', position: 13, homeTeam: 'ARG', awayTeam: 'CPV', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: 'Drew Fischer', date: '2026-07-03', time: '19:00', venueId: 'hardrock', homeSource: '1D', awaySource: '3B/E/F/I/J' },
  { id: 'R32-14', round: 'R32', position: 14, homeTeam: 'AUS', awayTeam: 'EGY', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: 'Gustavo Tejera', date: '2026-07-03', time: '15:00', venueId: 'att', homeSource: '1F', awaySource: '2C' },
  ...
  { id: 'R32-16', round: 'R32', position: 16, homeTeam: 'COL', awayTeam: 'GHA', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: 'Clement Turpin', date: '2026-07-03', time: '22:30', venueId: 'geha', homeSource: '1J', awaySource: '2H' },

  // ========== ROUND OF 16 (8 matches) ==========
  { id: 'R16-1', round: 'R16', position: 1, homeTeam: 'PAR', awayTeam: 'FRA', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-04', time: '18:00', venueId: 'lincoln', homeSource: 'W-R32-1', awaySource: 'W-R32-2' },
  { id: 'R16-2', round: 'R16', position: 2, homeTeam: 'CAN', awayTeam: 'MAR', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-04', time: '14:00', venueId: 'nrg', homeSource: 'W-R32-3', awaySource: 'W-R32-4' },
  { id: 'R16-3', round: 'R16', position: 3, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-06', time: '16:00', venueId: 'att', homeSource: 'W-R32-5', awaySource: 'W-R32-6' },
  { id: 'R16-4', round: 'R16', position: 4, homeTeam: null, awayTeam: 'BEL', homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-06', time: '21:00', venueId: 'lumen', homeSource: 'W-R32-7', awaySource: 'W-R32-8' },
  ...
  { id: 'R16-7', round: 'R16', position: 7, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-07', time: '13:00', venueId: 'mercedesbenz', homeSource: 'W-R32-13', awaySource: 'W-R32-14' },
  { id: 'R16-8', round: 'R16', position: 8, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-07', time: '17:00', venueId: 'bcplace', homeSource: 'W-R32-15', awaySource: 'W-R32-16' },

  // ========== QUARTERFINALS (4 matches) ==========
  { id: 'QF-1', round: 'QF', position: 1, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-09', time: '17:00', venueId: 'gillette', homeSource: 'W-R16-1', awaySource: 'W-R16-2' },
  { id: 'QF-2', round: 'QF', position: 2, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-10', time: '16:00', venueId: 'sofi', homeSource: 'W-R16-3', awaySource: 'W-R16-4' },
  { id: 'QF-3', round: 'QF', position: 3, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-11', time: '18:00', venueId: 'hardrock', homeSource: 'W-R16-5', awaySource: 'W-R16-6' },
  { id: 'QF-4', round: 'QF', position: 4, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-11', time: '22:00', venueId: 'geha', homeSource: 'W-R16-7', awaySource: 'W-R16-8' },

  // ========== SEMIFINALS (2 matches) ==========
  { id: 'SF-1', round: 'SF', position: 1, homeTeam: null, awayTeam: null, homeScore: null, awayScore: null, homePenalties: null, awayPenalties: null, referee: null, date: '2026-07-14', time: '16:00', venueId: 'att', homeSource: 'W-QF-1', awaySource: 'W-QF-2' },
