...
export const matchEvents: Record<number | string, MatchEvent[]> = {
 ...
 37: [
  ...
  'R32-6': [
    ...
    { time: "66'", type: "goal", team: "home", player: "Pedro Porro", secondaryPlayer: "Alex Baena", description: "2 - 0" },
    { time: "36'", type: "goal", team: "home", player: "Mikel Oyarzabal", secondaryPlayer: "Marc Cucurella", description: "1 - 0" }
  ],
  'R32-7': [
  ...
  'R32-10': [
    { time: "86'", type: "goal", team: "away", player: "Erling Haaland", secondaryPlayer: "Patrick Berg", description: "1 - 2" },
    { time: "74'", type: "goal", team: "home", player: "Amad Diallo", secondaryPlayer: "Nicolas Pépé", description: "1 - 1" },
    { time: "45'+1", type: "yellow", team: "away", player: "Antonio Nusa" },
    { time: "39'", type: "goal", team: "away", player: "Antonio Nusa", secondaryPlayer: "Martin Odegaard", description: "0 - 1" }
  ],
  'R32-11': [
    { time: "90'+9", type: "yellow", team: "away", player: "Moisés Caicedo" },
    { time: "90'+5", type: "red", team: "away", player: "Piero Hincapié" },
    { time: "90'+3'", type: "yellow", team: "away", player: "Kendry Páez" },
  ...
  'R32-14': [
    ...
    { time: "55'", type: "goal", team: "home", player: "Mohamed Hany (GC)", description: "1 - 1" },
    { time: "13'", type: "goal", team: "away", player: "Eman Ashour", secondaryPlayer: "Karim Hafez", description: "0 - 1" }
  ],
  'R32-15': [
